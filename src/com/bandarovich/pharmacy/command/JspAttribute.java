...
public class JspAttribute {
    ...
    public final static String IS_PHARMACIST = "isPharmacist";
    public final static String MAIL = "mail";
    public final static String PASSWORD = "password";
    public final static String MEDICINE = "medicine";
    public final static String CLIENT_MEDICINE_LIST = "clientMedicineList";
    ...
    public final static String DOCTOR_PRESCRIPTION_LIST = "doctorPrescriptionList";
